        ...
        },
        {
          ...
          functions: [
            ...
            },
            {
              ...
              example: 'subtract(50, 20) → 30',
            },
            {
              name: 'multiply',
              description: 'Multiply two numbers',
              signature: 'multiply(a, b)',
              example: 'multiply(5, 6) → 30',
            },
            {
              name: 'divide',
